...
(function($) {
    ...
    var $allContentDivs = $('#sampul-konten, #mempelai-konten, #acara-konten, #album-konten, #ucapan-konten, #lokasi-konten, #cerita-konten, #gift-konten').hide(); // Hide All Content Divs
    ...
    $('#sampul, #mempelai, #acara, #album, #ucapan, #lokasi, #cerita, #gift').click(function(){
    ...
    $('#submitKomen').on('click', function(event) {
        ...
        $.ajax({
            url : site_url+'welcome/add_komentar',
            method : "POST",
